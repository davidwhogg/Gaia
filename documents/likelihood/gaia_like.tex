...
% todo:
% - add comments about non-astrometric properties of the stars!
% - add comments about representation of complex distributions in the future!
% - cite qp paper?
...
It is the choice made in many publications (for example, \citealt{tri2, hawkins, lin}, among many others; this list is not exhaustive).
...
quantities (celestial position, parallax, and proper motion) but also
on photometric quantities (magnitudes, colors, reddenings).
