...
\quad ,
\end{eqnarray}
where we have marginalized out the true value.
These marginalized likelihoods can be multiplied together (or added in the log,
better) to make likelihoods for collections of stars.
