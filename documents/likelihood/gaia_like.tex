...
I am also implicitly mkaing another recommendation, but it is a bit more
subtle:
...
\emph{is}\footnote{%
  I'm also going to recommend that we ignore grammar issues
  related to whether the data \emph{is} something
  or the data \emph{are} something.}
