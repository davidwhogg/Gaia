...
this assumption for DR1 (TGAS), but not seriously. Generalizing beyond \Gaia,
...
TGAS, but the prior was so broad, it won't matter in practice. TECHNICALLY, you should use
